...
public static class SettingsSectionCatalog
{
    ...
    [
        ...
        new("Keybinds", "Keybinds", "Global shortcuts for capture, recording, replay, and on-screen tools."),
        new("Recording", "Recording", "MP4 profiles, audio, camera, countdown, and overlays."),
        new("Sharing", "Sharing", "Local export, queue behavior, providers, webhooks, and saved credentials."),
